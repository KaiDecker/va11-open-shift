...
if (!mixControl.Contains("global.cur_day >= 1001") || !mixControl.Contains("/v1/orders/resolve")) throw new Exception("Later Open Shift days did not resolve drink results");
...
if (!preloadCreate.Contains("/v1/story/prepare") || !preloadCreate.Contains("ag_preload_scope") || !preloadStep.Contains("ag_preload_scope") || !preloadStep.Contains("ag_prefetch_ready") || !preloadHttp.Contains("今日营业已准备完成") || !preloadHttp.Contains("global.jillcomment")) throw new Exception("Apartment story preparation gate or unique daily request scope was missing");
...
if (!toWorkMouse.Contains("global.cur_day >= 1001") || !toWorkMouse.Contains("global.ag_prefetch_ready != 1") || !toWorkMouse.Contains("instance_create(x, y, out_of_apartment)")) throw new Exception("Later Open Shift days did not wait for story preparation before work");
