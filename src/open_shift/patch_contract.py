...
def validate_patch_source_tree(path: str | Path) -> tuple[Path, ...]:
    ...
    expected = {
        ...
        "ag_tablet_controller_create.gml",
        "ag_tablet_controller_step.gml",
        "ag_preload_controller_create.gml",
        "ag_preload_controller_step.gml",
        "ag_preload_controller_http.gml",
        "ag_preload_controller_draw.gml",
